...
module.exports = function (self, requireName) {
    ...
    var HTMLCanvasElement = self.HTMLCanvasElement, idlUtils = require('jsdom/lib/jsdom/living/generated/utils');
    ...
    Object.defineProperty(HTMLCanvasElement.prototype, 'type', {
        ...
        set: function (type) {
            ...
            // PDF canvas.
            var impl = idlUtils.implForWrapper(this), size = impl._canvas || impl;
